...
const Eventshowcase = () => {
  ...
  const eventDetails = {
    ...
    description: "An exclusive showcase of our finest jewelry collections, featuring masterful craftsmanship and rare gemstones from around the world.",
  ...
  const showcaseItems = [
    {
      ...
      description: "Exquisite collection of diamond jewelry that captures the essence of celestial beauty.",
      highlight: "Featured rare pink diamonds"
    },
    {
      image: show2,
      name: "Royal Sapphire",
      description: "Inspired by royal heritage, these sapphire pieces blend tradition with contemporary design.",
      highlight: "Kashmir sapphires"
    },
    {
      image: show3,
      name: "Emerald Enchantment",
      description: "Vibrant emeralds set in artisan crafted settings that highlight their natural beauty.",
      highlight: "Colombian emeralds"
    },
    {
      image: show6,
      name: "Pearl Perfection",
      description: "Timeless pearl collections featuring South Sea and Akoya pearls in modern settings.",
      highlight: "Rare black pearls"
    },
    {
      image: hero1,
      name: "Gold Artistry",
      description: "Masterful goldsmithing techniques showcasing intricate designs and patterns.",
      highlight: "24K gold filigree"
    }
  ];

  return (
    <section ref={containerRef} className="py-24 bg-gradient-to-b from-stone-900 to-stone-800 text-white overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end">
            <div className="max-w-xl">
              ...
              >
                ...
                <span className="text-amber-400 uppercase tracking-widest text-sm font-medium">Event Showcase</span>
              </motion.div>
            ...
            >
              ...
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-8">
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-amber-400 uppercase tracking-wider text-xs font-medium">{showcaseItems[0].highlight}</span>
                </div>
                <h3 className="text-2xl font-medium mb-2">{showcaseItems[0].name}</h3>
                <p className="text-stone-300 max-w-lg">{showcaseItems[0].description}</p>
              </div>
            </motion.div>
                ...
                >
                  ...
                  <div className="absolute inset-0 z-20 flex flex-col justify-end p-6">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="text-amber-400 uppercase tracking-wider text-xs font-medium">{item.highlight}</span>
                    </div>
        ...
        >
          {showcaseItems.slice(3, 5).map((item, index) => (
            <motion.div 
              key={index}
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <a href="#gallery" className="inline-block px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full text-stone-900 font-medium hover:from-amber-400 hover:to-amber-500 transition-all duration-300 group">
